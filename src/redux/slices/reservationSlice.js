...
export const fetchUserReservations = createAsyncThunk('reservation/fetchUserReservations', async () => {
  const response = await fetch('https://driver-app-ezqp.onrender.com/api/user_reservations', {
    method: 'GET',
    headers: {
...
export const deleteReservation = createAsyncThunk(
  ...
  async (reservationId) => {
    const response = await fetch(`https://driver-app-ezqp.onrender.com/api/reservations/${reservationId}`, {
      method: 'DELETE',
      credentials: 'include',
    });

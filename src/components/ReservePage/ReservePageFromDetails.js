...
const ReservePageFromDetails = () => {
  ...
  useEffect(() => {
    const fetchCarDetails = async () => {
      try {
        const response = await fetch(`https://driver-app-ezqp.onrender.com/api/cars/${carId}`);
        if (!response.ok) {
  ...
  const handleReservation = async (e) => {
    ...
    try {
      const response = await fetch(`https://driver-app-ezqp.onrender.com/api/cars/${carId}/reservations`, {
        method: 'POST',
        headers: {
